...
return [
    ...
    */
    ...
    // -------------------pesonalizado-----------------------------
    'own_user' => 'No puede deshabilitar su propio usuario.',
    'authori_status' => 'No esta autorizado para ejecutar esta acción.',
    'delate' => 'No puede eliminar este perfil porque se esta utilizando en almeno un usuario.',
    'login' => 'Debe iniciar sesión para acceder a JARVIS.',
    'msj' => [
        'yes' => 'Registro Exitoso',
        'no' => 'hubo un error',
        'update' => 'Modificación Exitosa',
        'delete' => 'Desactivación Exitosa',
        'active' => 'Activación Exitosa',
        'deletereal' => 'Desactivación Exitosa',
    ],
    /*
    |--------------------------------------------------------------------------
