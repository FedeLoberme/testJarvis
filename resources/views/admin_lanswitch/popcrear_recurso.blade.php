    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" id="alta_recurso">
                ...
                <input type="hidden" name="ipran" id="ipran">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6" id="div_aplicar_reserva">
                    <div class="form-group">
                        <label>Aplicar una reserva a este equipo?<span style="color:red">* </label>
                        <select class="form-control" id="select_option_reserve">
                ...
                <div class="col-sm-6" id="bw_equipment_info" hidden>
                    <div class="form-group">
                    <label>Bw remanente <small class="text-navy">[MB]</small></label>
                        <input class="form-control" type="text" disabled id="bw_equipment" >
                    </div>
                </div>
                <div class="col-sm-12" id="reserve_input" hidden>
                    <div class="form-group">
                    <label>Reserva<span style="color:red">* </span><small class="text-navy">Bw reserva: <span class="bw_reserve"></span>[Mb]</small></label>
                        <div class="bw_all" id="bw_all" > 
                            <select class="form-control servicio_recurso hide-arrow-select" disabled="true" id="reserve_option" name="reserve_option">
                                <option selected disabled value="">Seleccionar</option>
                            </select>
                            <a class="ico_input btn btn-info" data-toggle="modal" data-target="#buscar_reserve_all" title="Buscar Reserva" onclick="reserve_list();"><i class="fa fa-search"> </i> Buscar</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="form-group">
                        <label>Servicio* <small class="text-navy">Bw Servicio: <span class="bw_service"></span>[MB]</small></label>
                        <div class="bw_all" id="bw_all" > 
                ...
                <div class="col-sm-6" id="ip_servicio" style="display: none;">
                    <div class="form-group">
                        ...
                        <div class="bw_all" id="bw_all" > 
                            ...
                            <a class="ico_input btn btn-info" onclick="buscar_ip_wan();" data-toggle="modal" data-target="#ip_admin_sele_lans" title="Buscar IP"><i class="fa fa-search"> </i></a>
