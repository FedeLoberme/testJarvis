...
@section('content')
        <li class="active">
            <strong>AGREGACIÓN IP</strong>
        </li>
        <li class="active">
            <a href="{{ url('ver/SAR') }}"><strong>SAR</strong></a>
        </li>
    </ol>
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        @if($authori_status['permi'] >= 10)
                            <a class="btn btn-success" data-toggle="modal" data-target="#crear_sar_pop" onclick="alta_sar_crear()"><i class="fa fa-sitemap"></i>
                                Nuevo SAR
                            </a>
                        @endif
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="jarvis_sar">
                            <input type="hidden" name="functi" id="functi" value="SAR">
...
@include('admin_sar.popcrear_sar')
