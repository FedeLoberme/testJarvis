<div class="modal inmodal fade pop_equi_general overflow-modal" id="crear_dm_pop" role="dialog" data-backdrop="static" aria-hidden="true" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button"  id="cerra_dm_pop" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <i class="fa fa-sitemap modal-icon"></i>
                <h4 class="modal-title" id="title_dm"></h4> 
                <input type="hidden" name="id_function" id="id_function" value="5">
            </div>
            <form role="form" method="POST" id="alta_dm">
                {{ csrf_field() }}
                <div class="col-sm-12">
            ...
            <div class="modal-footer">
                <div class="col-sm-12">
                    <button type="button" id="baja_dm_pop" class="btn" data-dismiss="modal" >
                        <i class="fa fa-times-rectangle-o"></i>
                        <strong>  Cancelar</strong>
                    </button>
                    <button id="alta_dm_pop" class="btn btn-primary" type="button">
