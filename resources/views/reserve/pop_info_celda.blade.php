<div class="modal inmodal fade" id="reserve_info_pop" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-sm" style="width: 400px">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" id="cerrar_reserve_info_pop"data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="col-md-12" style="margin-top: 15px">
                    ...
                    <div class="border-info-reserva " style="margin-top: 13px; margin-bottom: 10px; padding: 10px; min-height:175px;">
                        ...
                        <div class="row m-t-none">
                            <div class="col-md-12">
                        <small>Información de Uplink <b>al momento de reservar</b></small>
