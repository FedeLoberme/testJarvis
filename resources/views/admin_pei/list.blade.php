            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        @if($authori_status['permi'] >= 10)
                            <a class="btn btn-success" data-toggle="modal" data-target="#crear_pei_pop" onclick="alta_pei_crear();"><i class="fa fa-sitemap"></i>
                                Nuevo PEI
                            </a>
                        @endif
                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="jarvis_pei">
                        <input type="hidden" name="functi" id="functi" value="PEI">
...
@include('admin_pei.popcrear_pei')
